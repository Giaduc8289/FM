...
namespace GD.FM.CONTROL
{
	...
	/// </summary>
    public class BTN_HIENTHI : Button
    {
        ...
        public static void Loadimage(GD.FM.CONTROL.BUTTON _BUTTON, string imagename)
        {
            try
            {
                //_BUTTON.Image = Image.FromFile(GD.FM.LIB.PATH.ERP_PATH + @"\IMG\Icon\" + imagename);
		...
		#region Properties
        private ToolTip tl = new ToolTip();
        private GD.FM.CONTROL.toolmenufrm _toolmenufrm;
        public toolmenufrm TOOL
        {
            get { return _toolmenufrm; }
            set { _toolmenufrm = value; }
        }
        private string _tooltiptex;
        public string ToolTipTex
        {
            get { return _tooltiptex; }
            set { _tooltiptex = value; }
        }
		...
		protected override void OnClick(EventArgs ea)
		{
			...
			this.Invalidate();
            //GOI SU KIEN : "SUA HIEN THI TREN GRID"            
			base.OnClick(ea);
            _toolmenufrm.btnsetupview_Click(new object(), new EventArgs());
		}
