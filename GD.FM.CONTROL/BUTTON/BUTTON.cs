...
namespace GD.FM.CONTROL
{
    ...
    public class BUTTON : Button
    {
        ...
        public static void Loadimage(GD.FM.CONTROL.BUTTON _BUTTON, string imagename)
        {
            try
            {
                _BUTTON.Image = Image.FromFile(ERP_PATH + @"\IMG\Icon\" + imagename);
                _BUTTON.ImageAlign = ContentAlignment.MiddleLeft;
            }
            catch { }
        }
        public static void Loadimage(string PATH, GD.FM.CONTROL.BUTTON _BUTTON, string imagename)
        {
            try
            {
                _BUTTON.Image = Image.FromFile(PATH + @"\IMG\Icon\" + imagename);
                _BUTTON.ImageAlign = ContentAlignment.MiddleLeft;
            }
            catch { }
        }
