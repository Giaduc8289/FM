...
namespace GD.FM.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(GD.FM.DAL.EntityType.RolesEntity);
		}
		...
		public static IPrefetchPathElement2 PrefetchPathMenurole
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<MenuroleEntity>(EntityFactoryCache2.GetEntityFactory(typeof(MenuroleEntityFactory))),
					(IEntityRelation)GetRelationsForField("Menurole")[0], (int)GD.FM.DAL.EntityType.RolesEntity, (int)GD.FM.DAL.EntityType.MenuroleEntity, 0, null, null, null, null, "Menurole", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathUsers
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<UsersEntity>(EntityFactoryCache2.GetEntityFactory(typeof(UsersEntityFactory))),
					(IEntityRelation)GetRelationsForField("Users")[0], (int)GD.FM.DAL.EntityType.RolesEntity, (int)GD.FM.DAL.EntityType.UsersEntity, 0, null, null, null, null, "Users", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathMenuCollectionViaMenurole
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<MenuEntity>(EntityFactoryCache2.GetEntityFactory(typeof(MenuEntityFactory))), intermediateRelation,
					(int)GD.FM.DAL.EntityType.RolesEntity, (int)GD.FM.DAL.EntityType.MenuEntity, 0, null, null, GetRelationsForField("MenuCollectionViaMenurole"), null, "MenuCollectionViaMenurole", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{ 
			get { return (int)GD.FM.DAL.EntityType.RolesEntity; }
		}
		#endregion
