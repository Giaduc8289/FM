...
namespace GD.FM.APP.HETHONG
{
    public partial class FRM_USERS : FRM_DMPARENT
    {
        ...
        public FRM_USERS()
        {
            ...
            //GD.FM.LIB.GRID_COMM.Create_GRID_CONIG(dt111, LIB.PATH.FM_PATH + @"\XMLCONFIG\FRM_USERS.xml");
            ...
            GD.FM.LIB.GRID_COMM.LOAD_GRID_UIPanel(LIB.PATH.FM_PATH + @"\XMLCONFIG\FRM_USERS.xml", GRID_USERS, uiPanel0Container);
            FORM_PROCESS();
